...
public class AirExplore {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=e055bdf1da82d7c3e0280b58fbbb47acb22f76080045a196317f30d9b9e71cbb"); /*Service Key*/
        ...
        Gson gson = new Gson();
        AirQualityDto airQualityDto = gson.fromJson(sb.toString(), AirQualityDto.class);
        System.out.println(airQualityDto.getResponse().getBody().getItems().get(0).getSn());
        rd.close();
        conn.disconnect();
